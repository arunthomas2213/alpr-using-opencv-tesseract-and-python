...
# Reading Image
img = cv2.imread("/Users/arunthomas/Downloads/v1.png") #change the location of the image according to your system
...
saved_image.save("/Users/arunthomas/Desktop/SavedImage.png") #change the location of the image according to your system

# Tries to use tesseract or pyocr to find License Plate
b = tool.image_to_string(Image.open("/Users/arunthomas/Desktop/SavedImage.png"), lang=lang, builder=pyocr.builders.TextBuilder()) #change the location of the image according to your system
print(b)
